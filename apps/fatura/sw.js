...
self.TAHMISCI_PWA_CONFIG = Object.freeze({
  ...
  precache: [
    ...
    "/fatura/scripts/app.js?v=20260903-stock-excel-details",
    "/fatura/scripts/api.js",
    "/fatura/scripts/state.js?v=20260903-stock-excel-details",
    "/fatura/scripts/dashboard.js?v=20260902-final-ui",
    "/fatura/scripts/suppliers.js?v=20260902-final-ui",
