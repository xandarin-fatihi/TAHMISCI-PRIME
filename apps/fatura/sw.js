...
self.TAHMISCI_PWA_CONFIG = Object.freeze({
  ...
  precache: [
    "/fatura/styles/fatura.css?v=20260902-procurement",
    "/fatura/styles/stock.css?v=20260902-procurement",
    "/fatura/styles/product-analysis.css?v=20260829-product-analysis",
    "/fatura/scripts/app.js?v=20260902-procurement",
    "/fatura/scripts/api.js",
    "/fatura/scripts/state.js",
    "/fatura/scripts/dashboard.js?v=20260902-procurement",
    "/fatura/scripts/suppliers.js?v=20260902-procurement",
    "/fatura/scripts/receipts.js",
    "/fatura/scripts/documents.js?v=20260902-procurement",
    "/fatura/scripts/accounting.js?v=20260831-panel-access",
    "/fatura/scripts/ui-dialogs.js",
    "/fatura/scripts/stock.js?v=20260902-procurement",
    "/fatura/scripts/product-analysis.js?v=20260902-procurement",
